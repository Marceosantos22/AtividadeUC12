...
public class GuiJTableBuscaPaciente extends javax.swing.JInternalFrame {
	...
	public boolean valida() {
		...
		String selecao = (String) jcomboFiltro.getSelectedItem();
		String filtro = jtFiltro.getText();

		if (selecao.equals("Código Paciente")) {
		...
		} else if (selecao.equals("CPF")) {
			
			if (!filtro.matches("[0-9.-]+")) {
				
				JOptionPane.showMessageDialog
		  (null, "Digite apenas números, pontos ou traços.");
				resultado = false;
				
			}
			
		} else if (selecao.equals("Nome Paciente")) {
			
			if (!filtro.matches("^[a-zA-Z\\s]+$")) {
				
				JOptionPane.showMessageDialog
		  (null, "Digite apenas letras e espaços.");
				resultado = false;
